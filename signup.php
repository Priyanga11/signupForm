...
<div class="container">
        ...
        <form name="signupform" id="form"  enctype="multipart/form-data" onsubmit="return validation()"  method="post" >
                <div class="ab"> 
                    <label class="abc" for="username">UserName:</label>
                        <input class="a1" type="text" placeholder="UserName" id="Username" name="username" >
                        <input type="hidden" name="user_id" value=<?php echo rand(0,9999); ?> readonly = "true" />
                        <p id="aaa"><p>
                </div><br> 
                <div class="ab">
                    <label class="abc" for="password">Password:</label>
                        <input class="a2" type="password" placeholder="Password" id="Password" name="password" >
                        <p id="bbb"><p>
                </div><br>
                <div class="ab">
                    <label class="Gender" for="gender">Gender:</label>
                        <input class="a3" type="radio" id="Gender" value="Male" name="Gender">Male
                        <input type="radio"  value="Female" name="Gender">Female 
                        <input type="radio"  value="Others" name="Gender">Others
                        <p id="ccc"><p>
                </div><br>
                <div class="ab">
                    <label class="abc" for="email">EmailId:</label>
                        <input class="a4" type="text" placeholder="Email" id="Email" name="Email"  >
                        <p id="ddd"><p>
                </div><br> 
                <div class="ab">
                    <label class="abc" for="DOB">DOB:</label>
                        <input class="a5" type="text" placeholder="yyyy-mm-dd" id="DOB"  name="birthday" >
                        <p id="eee"><p>
                </div><br>
                    
                <div class="ab">
                    <label class="Country" for="Country">Country:</label>
                        <select class="a6" name="countryCode" id="Country" >
                    ...
                    <option data-countryCode="PF" value="French Guiana (+594)">French Polynesia (+689)</option>
                    ...
                    <option data-countryCode="PL" value="Philippines (+63)">Poland (+48)</option>
                ...
                <div class="ab">    
                    <label class="Contact" for="Phone">ContactNo:</label>
                    <input class="a7" type="tel" placeholder="ContactNumber" id="Phone" name="Phone"><br><br>
                    <p id="ggg"><p>
                </div><br>
                <div class="ab">    
                    <label class="Image" for="Image">Upload Image:</label>
                        <input class="a8" type="file" id="image" name="image" accept="image/*"><br><br>
                        <p id= "hhh"><p>
                </div><br> 
                <div class="ab">    
                    <label class="Image" for="Image">Upload GImage:</label>
                        <input class="a8" type="file" id="genimage" name="genimage" accept="image/*"><br><br>
                        <p id= "hhh1"><p>
                </div><br> 
                <div class="ab">    
                    <label class="Image" for="Image">Upload CImage:</label>
                        <input class="a8" type="file" id="countryimage" name="countryimage" accept="image/*"><br><br>
                        <p id= "hhh2"><p>
                </div><br> 
                <div class="ab">    
                    <label class="Doc" for="Doc">Upload File:</label>
                        <input class="a9" type="file" id="doc" name="doc" accept="pdf/*,docx/*"><br><br>
                        <p id="iii"><p>
                </div><br>
            
            <button id="submit" type="submit"  value="Submit" name="submit" >SignUp</button>
    </form>
